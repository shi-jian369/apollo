...
Status OpenSpaceFallbackDeciderPark::Process(Frame* frame) {
  ...
  BuildStaticObstacleEnvironment(frame->obstacles(), static_obstacles);
...
void OpenSpaceFallbackDeciderPark::BuildPredictedEnvironment(
...
void OpenSpaceFallbackDeciderPark::BuildStaticObstacleEnvironment(
    const std::vector<const Obstacle*>& obstacles,
    std::vector<Obstacle*>& static_obstacles) {
...
bool OpenSpaceFallbackDeciderPark::IsCollisionFreeTrajectory(
